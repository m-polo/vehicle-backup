...
{
    public class FeedProcess(IAPIService apiService, IMapperService mapperService, IExportService exportService, ILoggingService logger)
    {
        ...
        public async Task RunAsync()
        {
            ...
            _exportService.WriteItemsInfo(vehicles, "csv");
